...
parser.add_argument("-s", "--output-unidentified-sim-mutations", action="store_true", help="Output all simulated ASV mutations that do not have an exact match or similar match generated by EvoTraceR")
parser.add_argument("-i", "--output-matched-sim-mutations", action="store_true", help="Output all simulated ASV mutations that have an exact match generated by EvoTraceR")
parser.add_argument("-m", "--map-similar-evo-sim-mutations", action="store_true", help="EvoTraceR ASV mutations without an exact match in the simulated data are mapped to the most similar ASV mutations in the simulated data. Similar mutations' positions are shifted by at most the length of the mutated sequence and characters are rotated by at most one character.")
